...
class Pikachu(Pokemon):
    '''
    Pikachu class with Electric-type move.
    '''
    MOVES = {1: ("Slash", 7, 0.85), 2: ("Punch", 9, 0.80), 3: ("Thunder Shock", 30, 0.45), 4: ("Nuzzle", 15, 0.75)} #Default moves. In format: Key: (Move Name, Base Value, Modifier) 

    def __init__(self):
        super().__init__(name = "Pikachu", pokemon_type = "Electric", moves = Pikachu.MOVES) #Initializes with the name, pokemon type and moves.
