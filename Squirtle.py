...
class Squirtle(Pokemon):
    '''
    Squirtle class with Grass-type move.
    '''
    MOVES = {1: ("Slash", 7, 0.85), 2: ("Punch", 9, 0.80), 3: ("Water Tail Whip", 30, 0.45), 4: ("Water Gun", 15, 0.75)} #Default moves. In format: Key: (Move Name, Base Value, Modifier) 

    def __init__(self):
        super().__init__(name = "Squirtle", pokemon_type = "Water", moves = Squirtle.MOVES) #Initializes with the name, pokemon type and moves.
